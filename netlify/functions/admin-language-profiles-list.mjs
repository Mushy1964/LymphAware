...
export default async (request) => {
  ...
  try {
    ...
    const languageResponse = await fetchWithTimeout(
      `${process.env.SUPABASE_URL}/rest/v1/language_profiles?select=id,user_id,source_profile_id,order_id,order_item_id,language_code,language_name,setup_status,qr_profile_active,qr_token,card_production_status,translation_error,translation_generated_at,translation_source_updated_at,created_at,updated_at&order=created_at.asc`,
